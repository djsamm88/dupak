    ...
    <div class="modal-content">
      ...
      <div class="col-sm-4">Harga Retail</div>
        ...
        <div class="col-sm-4">Harga Lusin</div>
            <div class="col-sm-8"><input type="text" name="harga_lusin" id="harga_lusin"  class="form-control nomor" placeholder="harga_lusin"></div>
            <div style="clear: both;"></div><br>


        <div class="col-sm-4">Harga Koli</div>
            <div class="col-sm-8"><input type="text" name="harga_koli" id="harga_koli"   class="form-control nomor" placeholder="harga_koli"></div>
            <div style="clear: both;"></div><br>



        <div class="col-sm-4">Jumlah/Lusin</div>
            <div class="col-sm-8"><input type="text" name="jum_per_lusin" id="jum_per_lusin" class="form-control nomor" placeholder="jum_per_lusin" ></div>
            <div style="clear: both;"></div><br>
        


        <div class="col-sm-4">Jumlah/Koli</div>
            <div class="col-sm-8"><input type="text" name="jum_per_koli" id="jum_per_koli" class="form-control nomor" placeholder="jum_per_koli" ></div>
            <div style="clear: both;"></div><br>
            ...
            <input type="hidden" name="reminder" id="reminder" value="0" class="form-control nomor" placeholder="reminder gudang" >
        ...
        <input type="hidden" name="berat" id="berat" class="form-control" value="0" placeholder="Berat (KG) ex: 0.1" min="0" pattern="[0-9]+([\,|\.][0-9]+)?" step="0.01" >
