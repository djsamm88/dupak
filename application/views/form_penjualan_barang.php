...
<form id="penjualan_barang">
  ...
  <div class="col-sm-3">
    <input type="text" name="nama_pembeli" id="nama_pembeli" value="<?php echo @$data[0]->nama_pembeli?>" class="form-control" value="-" placeholder="Nama pembeli">
    <input type="hidden" name="id_pelanggan" id="id_pelanggan" value="<?php echo @$data[0]->id_pelanggan?>">
    <small><i>Nama Pembeli</i></small>
  </div>
  <div class="col-sm-3">
    <input type="text" name="hp_pembeli" id="hp_pembeli" value="<?php echo @$data[0]->hp_pembeli?>" class="form-control" value="-" placeholder="HP pembeli">
    <small><i>HP Pembeli</i></small>
  </div>
  <input type="hidden" name="nama_packing" value="<?php echo @$data[0]->nama_packing?>" class="form-control" placeholder="Nama Packing">
...
<input id="t4_transport_ke_ekspedisi" type="hidden" name="transport_ke_ekspedisi" class="form-control nomor" value="0" style="text-align:right;">
