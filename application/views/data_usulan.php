          ...
          $no++;
            ...
            echo (" 
              ...
              <tr>
                ...
                <td>
                  <button class='btn btn-primary btn-xs' id='' onclick='penilaian($x->tahun,".'"'.$x->NIP.'"'.")'>Penilaian</button>
...
function penilaian(tahun,NIP)
{
  ...
  $.get("<?php echo base_url()?>index.php/semua/data_penilaian_by_nip",{tahun:tahun,NIP:NIP},function(e){
    $("#t4_konten").html(e);
  })
  $("#myModal_dokumen").modal('show');
}
